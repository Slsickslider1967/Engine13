    ...
    public class ImGuiController : IDisposable
    {
        ...
        private void RenderDrawData(ImDrawDataPtr drawData, CommandList cl)
        {
            ...
            for (int n = 0; n < drawData.CmdListsCount; n++)
            {
                ...
                if (vb > 0)
                {
                    cl.UpdateBuffer(_vertexBuffer, vtxOffset, (IntPtr)cmdList.VtxBuffer.Data, vb);
                    vtxOffset += vb;
                }
                if (ib > 0)
                {
                    cl.UpdateBuffer(_indexBuffer, idxOffset, (IntPtr)cmdList.IdxBuffer.Data, ib);
                    idxOffset += ib;
                }
            }
            ...
            cl.UpdateBuffer(_projBuffer, 0, ref proj);
